...
export const en: Dictionary = {
  nav: {
    ...
    descFeatures: "All 144 features built for your business",
    descIndustries: "Find the right fit for your industry",
    descPricing: "Simple pricing, no surprises",
    descAbout: "POS terminals, printers and peripherals",
    descTown: "Community and academy for Astana users",
    descPartner: "Become a reseller, distributor or affiliate",
    descBlog: "Tips and updates for Malaysian SMEs",
    descContact: "Talk to our team — we reply fast",
  },
  languageToggle: {
    bm: "BM",
    en: "EN",
